...
import { directions, trackingsShopping } from "../../data/dataArrays";
import { getDetailShopping } from "../../data/MockDataAPI";
import Modal from "react-native-modal";
import RoundCheckbox from "react-native-round-checkbox";

export default function ShoppingDetailScreen(props) {
  const { navigation, route } = props;

  const [isModalVisibleTracking, setModalVisibleTracking] = useState(true);
  const item = route?.params?.id;
  const detail = getDetailShopping(item);
      ...
      <View>
        ...
        <View style={styles.containerItem}>
            ...
            <View style={styles.containerDetail}>
              <View style={{ width: "20%" }}>
                <Image
                  ...
                  source={{
                    uri: "https://sanfranciscodekkerlab.com/dekkershop/icono-fondo.png",
                  }}
                />
              </View>
              ...
              <View style={{ width: "80%" }}>
                <View>
                  ...
                  <View style={styles.pillPayment}>
                    <Text style={styles.titlePayment}>CEDIS</Text>
                  </View>
                </View>
              </View>
            </View>
              ...
              <View style={{ width: "100%" }}>
                <View>
                  <Text style={styles.titleDirection}>
                    C. Ejido 5970, San Baltazar Linda Vista, 72550 Puebla, Pue
                  </Text>
                </View>
              </View>
            </View>
          ...
          <View style={styles.containerDate}>
            <View style={{ width: "40%" }}>
              <Text style={styles.textDate}>222-244-2933</Text>
            </View>
            <View style={{ width: "60%" }}>
